...
const AllApartments = () => {
  ...
  const [currentMinValue, setCurrentMinValue] = useState(2000);
  ...
  const {
    ...
    queryFn: async () => {
      ...
      const res = await axiosPublic
        .get(`/allApartments?${params.toString()}`)
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex items-center mb-6">
        ...
        <div className="flex items-center gap-2 mx-3">
          ...
          <select
            className="select select-bordered w-full max-w-xs px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
